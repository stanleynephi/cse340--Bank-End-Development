...
--creating the enumeration needed for the database
 CREATE TYPE public.account_type AS ENUM
    ('client', 'employee', 'admin');

    ALTER TYPE public.account_type
        OWNER TO cse340_backend;
    
--creating the needed tables for the database (classifications, inventory, accounts)
    --classifications
...
--altering the table to create the relationships between the classifications and then inventory table
...
--inserting the data into the inventory table
...
--alter the GM Hummer description to change from small interior to a huge interior
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_id = 10;

--alter the image path in the inv_image and also in the inv_thumbnail
update public.inventory
